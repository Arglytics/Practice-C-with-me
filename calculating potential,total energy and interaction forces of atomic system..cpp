  ...
  for (int i=0; i< number_of_atoms; i++)
  {
    ...
    for (int j=0; j< number_of_atoms; j++)
    {
      if (i == j)
      {
		...
		distance = sqrt(dist_i_j[0]*dist_i_j[0] + dist_i_j[1]*dist_i_j[1] + dist_i_j[2]*dist_i_j[2]);
		...
		forcei_j[i][0] = forcei_j[i][0] + 24*epsilon*(1/distance)*(d6- 2*d12)*(dist_i_j[0]/distance);
		forcei_j[i][1] = forcei_j[i][1] + 24*epsilon*(1/distance)*(d6- 2*d12)*(dist_i_j[1]/distance);      
		forcei_j[i][2] = forcei_j[i][2] + 24*epsilon*(1/distance)*(d6- 2*d12)*(dist_i_j[2]/distance);
    }
    //save to output file
